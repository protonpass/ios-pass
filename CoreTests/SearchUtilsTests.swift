...
"""
    ...
    func testSearchWithEmoji() throws {
        ...
        // Then
        XCTAssertEqual(searchResult.matchedPhrase, "s feelings so we can use emoji such AS 👻 and 😢. And finally a long, meaningl")
    ...
    func testSearchWithNonAlphabetCharacters() throws {
        ...
        // Then
        XCTAssertEqual(searchResult.matchedPhrase, " Asian languages: The Japanese say \"こんにちは\" (konnichiwa), the Chinese say \"你好\"")
        XCTAssertEqual(searchResult.matchedWord, query)
        XCTAssertFalse(searchResult.isLeadingPhrase)
        XCTAssertFalse(searchResult.isTrailingPhrase)
    }
