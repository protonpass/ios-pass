//
// UpdatePendingFileEndpoint.swift
...
struct UpdatePendingFileEndpoint: Endpoint {
    ...
    var body: UpdatePendingFileRequest?

    init(fileId: String, metadata: String) {
        debugDescription = "Update pending file metadata"
        path = "/pass/v1/file/\(fileId)/metadata"
        method = .put
