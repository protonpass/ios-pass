//
// LocalCoreEventIdDatasource.swift
...
public protocol LocalCoreEventIdDatasourceProtocol: Sendable {
...
public final class LocalCoreEventIdDatasource:
    LocalDatasource, LocalCoreEventIdDatasourceProtocol, @unchecked Sendable {}

public extension LocalCoreEventIdDatasource {
    func getLastEventId(userId: String) async throws -> String? {
        let taskContext = newTaskContext(type: .fetch)
        let fetchRequest = CoreEventIDEntity.fetchRequest()
    ...
    func upsertLastEventId(userId: String, lastEventId: String) async throws {
        try await upsert([lastEventId],
                         entityType: CoreEventIDEntity.self,
    ...
    func removeLastEventId(userId: String) async throws {
        ...
        let fetchRequest = NSFetchRequest<any NSFetchRequestResult>(entityName: "CoreEventIDEntity")
        fetchRequest.predicate = .init(format: "userID = %@", userId)
