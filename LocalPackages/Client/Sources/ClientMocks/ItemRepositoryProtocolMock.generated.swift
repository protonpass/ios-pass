...
public final class ItemRepositoryProtocolMock: @unchecked Sendable, ItemRepositoryProtocol {
    ...
    // MARK: - pinItems
    public var pinItemsThrowableError32: Error?
    ...
    public func pinItems(_ items: [any ItemIdentifiable]) async throws {
        ...
        if let error = pinItemsThrowableError32 {
            throw error
        }
        closurePinItems()
    }
    // MARK: - unpinItems
    public var unpinItemsThrowableError33: Error?
    ...
    public func unpinItems(_ items: [any ItemIdentifiable]) async throws {
        ...
        if let error = unpinItemsThrowableError33 {
            throw error
        }
        closureUnpinItems()
    }
