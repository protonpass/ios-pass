...
public final class ItemRepositoryProtocolMock: @unchecked Sendable, ItemRepositoryProtocol {
    ...
    // MARK: - resetHistory
    public var resetHistoryThrowableError38: Error?
    ...
    public func resetHistory(_ item: any ItemIdentifiable) async throws {
        ...
        if let error = resetHistoryThrowableError38 {
            throw error
        }
        closureResetHistory()
    }
    // MARK: - importLogins
    public var importLoginsUserIdShareIdLoginsThrowableError39: Error?
    ...
    public func importLogins(userId: String, shareId: String, logins: [CsvLogin]) async throws {
        ...
        if let error = importLoginsUserIdShareIdLoginsThrowableError39 {
            throw error
        }
        closureImportLogins()
    }
    // MARK: - totpCreationDateThreshold
    public var totpCreationDateThresholdNumberOfTotpThrowableError40: Error?
    ...
    public func totpCreationDateThreshold(numberOfTotp: Int) async throws -> Int64? {
        ...
        if let error = totpCreationDateThresholdNumberOfTotpThrowableError40 {
            throw error
        }
