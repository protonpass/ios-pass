...
public final class ItemRepositoryProtocolMock: @unchecked Sendable, ItemRepositoryProtocol {
    ...
    public var changeAliasStatusUserIdItemEnableThrowableError7: Error?
    ...
    public var invokedChangeAliasStatusParameters: (userId: String, item: ItemContent, enable: Bool)?
    public var invokedChangeAliasStatusParametersList = [(userId: String, item: ItemContent, enable: Bool)]()

    public func changeAliasStatus(userId: String, item: ItemContent, enable: Bool) async throws {
        invokedChangeAliasStatusfunction = true
        invokedChangeAliasStatusCount += 1
        invokedChangeAliasStatusParameters = (userId, item, enable)
        invokedChangeAliasStatusParametersList.append((userId, item, enable))
        if let error = changeAliasStatusUserIdItemEnableThrowableError7 {
            throw error
        }
