//
// PasswordPolicyResolution.swift
...
public struct PasswordPolicyResolution: Sendable, Equatable {
    public let preferences: PasswordPreferences
    public let bounds: PasswordPolicyBounds
    public let allowsTypeSelection: Bool
    public let lockedOptions: PasswordPolicyLockedOptions

    public init(preferences: PasswordPreferences,
                bounds: PasswordPolicyBounds,
                allowsTypeSelection: Bool,
                lockedOptions: PasswordPolicyLockedOptions) {
