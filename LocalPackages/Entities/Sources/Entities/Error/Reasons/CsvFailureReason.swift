...
public extension PassError {
    enum CsvFailureReason: CustomDebugStringConvertible, Sendable {
        case invalidNumberOfColumn(Int)
        case unexpectedColumnName(index: Int, expectation: String, value: String)
        case invalidRow(Int)
