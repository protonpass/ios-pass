...
//
//    @Test("Path to root item")
//    func pathToRootItem() {
//        let index = content.lookupTable
//
//        let path = index.path(to: itemA.id)
//
//        #expect(path == [
//            Entities.ShareContentID.item(itemA.id.contentId)
//        ])
//    }
//
//    @Test("Path to nested item")
//    func pathToNestedItem() {
//        let index = content.lookupTable
//
//        let path = index.path(to: itemC.id)
//
//        #expect(path == [
//            Entities.ShareContentID.folder(folderF1.id.contentId),
//            Entities.ShareContentID.folder(folderF2.id.contentId),
//            Entities.ShareContentID.item(itemC.id.contentId)
//        ])
//    }
//
//    // MARK: - Counting
//
//    @Test("Top-level item count ignores folders")
//    func itemCount() {
//        #expect(content.itemCount == 1) // only item-A at root
//    }
//
//    @Test("Complete item count includes nested items")
//    func completeItemCount() {
//        #expect(content.completeItemCount == 3)
//    }
//
//    // MARK: - Folder semantics
//
//    @Test("Folder elements are marked as folders")
//    func folderDetection() {
//        let index = content.lookupTable
//
//        let folder = index.element(for: .folder("folder-F1"))
//        #expect(folder?.isFolder == true)
//    }
//
//    // MARK: - Safety
//
//    @Test("Unknown element returns nil")
//    func unknownElement() {
//        let index = content.lookupTable
//
//        #expect(index.element(for: .item("unknown")) == nil)
//        #expect(index.path(to: .item("unknown")) == nil)
//    }
}
