//
//
// ToggleMonitoringForCustomEmail.swift
...
public protocol ToggleMonitoringForCustomEmailUseCase: Sendable {
    func execute(email: CustomEmail) async throws -> CustomEmail
}

public extension ToggleMonitoringForCustomEmailUseCase {
    func callAsFunction(email: CustomEmail) async throws -> CustomEmail {
        try await execute(email: email)
    }
}

public final class ToggleMonitoringForCustomEmail: ToggleMonitoringForCustomEmailUseCase {
