...
struct ParseCsvLoginsTests {
    ...
    func invalidNumberOfColumn() async throws {
        ...
        await #expect(throws: PassError.csv(.invalidNumberOfColumn(6))) {
            try await sut(csv)
        }
    }
    ...
    func successWithNoteColumn() async throws {
        ...
        proton.me,https://account.proton.me/switch,nobody@proton.me,proton123,"Note 1"
        missing url,,missingurl@proton.me,"proton, 123",Note 2
        missing password,https://account.proton.me/switch,missingpw,,
        broken url,htt:/proton.me/switch,brokenurl@proton.me,,Note 4
        """
