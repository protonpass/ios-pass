...
final class APIManagerTests: XCTestCase {
    ...
    func testAPIServiceIsCreatedWithSessionIfUnauthSessionIsPersisted() throws {
        // GIVEN
        SharedDataContainer.shared.appData().setCredentials(unauthSessionCredentials)
    ...
    func testAPIServiceIsCreatedWithSessionIfAuthSessionIsPersisted() throws {
        ...
        SharedDataContainer.shared.appData().setCredentials(userData.credential)
...
//
//enum TestAppDataKey: String {
//    case testUserData
//    case testCurrentCredential
//}
//
//final class MockAppData: FullDataProvider {
//
//    @LockedKeychainStorage(key: TestAppDataKey.testCurrentCredential, defaultValue: nil)
//    private var credential: AuthCredential?
//    
//    @LockedKeychainStorage(key: TestAppDataKey.testUserData, defaultValue: nil)
//    private var userData: UserData?
//
//    init() {}
//
//    func setCredentials(_ newCredential: AuthCredential?) {
//        print("woot Mock data set credential \(newCredential)")
//        credential = newCredential
//    }
//
//    func getCredentials() -> AuthCredential? {
//        print("woot Mock get credential")
//
//        return credential
//    }
//    
