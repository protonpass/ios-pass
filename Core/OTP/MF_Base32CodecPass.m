...
@implementation MF_Base32CodecPass
...
-(NSString *)base32String
{
    ...
    return [MF_Base32CodecPass base32StringFromData:utf8encoding];
}
+(NSString *)stringFromBase32String:(NSString *)base32String
{
    NSData *utf8encoding = [MF_Base32CodecPass dataFromBase32String:base32String];
...
{
    return [MF_Base32CodecPass dataFromBase32String:base32String];
}
-(NSString *)base32String
{
    return [MF_Base32CodecPass base32StringFromData:self];
}
@end
