...
if [[ "$CONFIGURATION" == "Debug-QA" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ProtonCore-CryptoGoImplementation/ProtonCore_CryptoGoImplementation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ProtonCore-CryptoGoInterface/ProtonCore_CryptoGoInterface.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ProtonCore-GoLibs/ProtonCore_GoLibs.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ProtonCore-AccountDeletion/ProtonCore_AccountDeletion.framework"
