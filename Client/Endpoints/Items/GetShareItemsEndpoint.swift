...
public struct GetShareItemsResponse: Decodable {
    let code: Int
    let items: ItemRevisionList
}

public struct GetShareItemsEndpoint: Endpoint {
    public typealias Body = EmptyRequest
    public typealias Response = GetShareItemsResponse
